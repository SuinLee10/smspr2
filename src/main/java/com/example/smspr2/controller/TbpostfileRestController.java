...
import com.example.smspr2.service.TbpostfileService;
...
@Tag(name = "1-1_1. 게시글 첨부파일 API 안내", description = "게시글 첨부파일 관련 기능 정의한 RestController.")
@RequestMapping("/api/tbpostfile")
@RestController
public class TbpostfileRestController {
    private TbpostfileService tbpostfileService;
    ...
    @Operation(summary = "게시글 첨부파일 목록 스크롤 조회",
            description = "게시글 첨부파일목록 스크롤 조회 컨트롤러<br />"
